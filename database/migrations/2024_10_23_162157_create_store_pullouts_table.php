...
class CreateStorePulloutsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('store_pullouts', function (Blueprint $table) {
            $table->id();
            ...
            $table->date('pullout_schedule_date')->nullable();
            $table->date('pick_list_date')->nullable();
            $table->date('pick_confirm_date')->nullable();
    ...
    {
        Schema::dropIfExists('store_pullouts');
    }
}
