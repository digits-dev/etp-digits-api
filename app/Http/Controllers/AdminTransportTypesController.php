...
use crocodicstudio\crudbooster\helpers\CRUDBooster;
	...
	class AdminTransportTypesController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "transport_type";
			$this->limit = "20";
			$this->orderby = "transport_type,desc";
