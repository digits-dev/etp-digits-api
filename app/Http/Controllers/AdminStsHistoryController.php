<?php namespace App\Http\Controllers;
	...
	class AdminStsHistoryController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Received Document Number","name"=>"received_document_number","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			...
			//$this->form[] = ["label"=>"Transfer Schedule Date","name"=>"transfer_schedule_date","type"=>"date","required"=>TRUE,"validation"=>"required|date"];
