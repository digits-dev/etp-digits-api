...
use crocodicstudio\crudbooster\helpers\CRUDBooster;
	...
	class AdminTransferGroupsController extends \crocodicstudio\crudbooster\controllers\CBController {

	    public function cbInit() {

			# START CONFIGURATION DO NOT REMOVE THIS LINE
			$this->title_field = "group";
			$this->limit = "20";
			$this->orderby = "group,desc";
			...
			$this->table = "transfer_groups";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Group","name"=>"group"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Group','name'=>'group','type'=>'text','validation'=>'required|min:1|max:50','width'=>'col-sm-5'];
	    ...
	    public function actionButtonSelected($id_selected,$button_name) {
            ...
            TransferGroup::whereIn('id', $id_selected)->update($value);
	    }
