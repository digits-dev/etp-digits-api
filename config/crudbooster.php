...
return [
    ...
    */
    ...
    'PASSWORD_FIELDS_CANDIDATE' => 'password,pass,pwd,passwrd,pin',
    ...
    'NAME_FIELDS_CANDIDATE' => 'name,nama,person_name,person,fullname,full_name,nickname,nick,nick_name,title,content',
