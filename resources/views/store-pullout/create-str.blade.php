...
@if ($errors->any())
    ...
    <div class="panel panel-default" id="pullout_form">
        ...
        <div class="panel-body">
            ...
            <form action="" method="POST" id="str_create" autocomplete="off" role="form" enctype="multipart/form-data">
            ...
            <div class="col-md-3">
                <div class="form-group">
                    <label class="control-label">Pullout Date: <span class="required">*</span></label>
                        <input type='date' required name='pullout_date' id="pullout_date" onkeydown="return false" autocomplete="off" class='form-control'  required/>
                </div>
            </div>
            ...
            <div class="col-md-12">
                ...
                <h5 style="color: red;"><b>*If an item is a customer return, please use DAS (Digits Aftersales System). </h5>
